...
\begin{wrapfigure}{R}{0.25\linewidth}
    ...
    \caption{\href{https://www.ehu.eus/eu/}{EHU}}
    \label{fig:ehu}
\end{wrapfigure}
...
Horrez gain, badago algoritmoak definitzeko bi ingurune, \texttt{ifalgorithm} eta \texttt{ifpseudo}. Posible da irudien eta taulen aurkibideaz gain, algoritmoen aurkibide bat sortzea. \ref{alg:adibidea} Kode zatian adibide bat ikusi daiteke.
