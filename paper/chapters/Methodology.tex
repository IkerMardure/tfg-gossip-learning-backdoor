...
To guarantee that the malicious update survived the decentralized aggregation process, we applied the Model Boosting technique. However, unlike centralized Federated Learning where the boosting factor ($\alpha$) is scaled relative to the total number of clients, in Decentralized Federated Learning, the dilution of the attackis governed by the local topological degree ($d$) of the adversary's node. 
