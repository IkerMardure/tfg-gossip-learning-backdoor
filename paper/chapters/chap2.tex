...
\begin{wrapfigure}{R}{0.25\linewidth}
    \centering
    \vspace{-0.6cm}
    \includegraphics[width=0.4\linewidth]{figures/EHU_logotipo_positiboa_BAXUA.png}
    \caption{\href{https://www.ehu.eus/es/}{EHU}}
    \label{fig:upv}
\end{wrapfigure}
...
Además de estos elementos existen dos entornos para definir algoritmos, \texttt{ifalgorithm} y \texttt{ifpseudo}. También es posible incluir un índice de algoritmos además de los índices de tablas y figuras. En el fragmento de código \ref{alg:ejemplo} se muestra un ejemplo de la sintaxis.
